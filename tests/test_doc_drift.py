...
def test_count_drift_in_claude_md_is_caught(repo):
    ...
    _mutate(repo, "CLAUDE.md", "MCP Server (15 tools", "MCP Server (11 tools")
...
def test_count_drift_in_readme_still_caught(repo):
    ...
    _mutate(repo, "README.md", "MCP Server (15 tools)", "MCP Server (8 tools)")
...
def test_claude_md_table_list_drift_is_caught(repo):
    ...
    _mutate(repo, "CLAUDE.md", ", route_evidence, run_cards, judge_runs, govern_batches, task_runs, context_packets, context_packet_items)", ")")
    _mutate(repo, "CLAUDE.md", "(29 tables:", "(23 tables:")
...
def test_deleting_a_claim_is_not_a_way_to_pass(repo):
    ...
    _mutate(repo, "CLAUDE.md", "- 24 routers (~94 endpoints), 15 MCP tools", "- routers, MCP tools")
